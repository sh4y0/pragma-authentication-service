...
class HandlerRestTest {
    ...
    void logIn_success() {
        ...
        StepVerifier.create(handler.logIn(mockRequest(loginRequest)))
                .assertNext(res -> {
    ...
    void signUp_success() {
        ...
        StepVerifier.create(handler.signUp(mockRequest(signUpRequest)))
    ...
    void signInDoc() {
        StepVerifier.create(handler.signInDoc(loginRequest))
                .expectComplete()
                .verify();
    }
}
